defmodule FuzzyCatalogWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FuzzyCatalogWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FuzzyCatalogWeb.Gettext, "errors", msg, opts)
    end
  end
