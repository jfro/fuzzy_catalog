defmodule FuzzyCatalog.Accounts do
  @moduledoc """
  ...
  alias FuzzyCatalog.Accounts.{User, UserToken, UserNotifier}
  ...
  See `FuzzyCatalog.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `FuzzyCatalog.Accounts.User.password_changeset/3` for a list of supported options.
